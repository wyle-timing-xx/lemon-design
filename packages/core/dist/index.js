...
const Input = React.forwardRef(({ className, variant = 'outlined', size = 'md', error = false, errorMessage, helperText, label, placeholder, required = false, disabled = false, ...props }, ref) => {
    ...
    return (jsxRuntime.jsx("div", { className: "w-full", children: jsxRuntime.jsx(material.TextField, { ref: ref, className: cn('w-full', getSizeClasses(), className), variant: variant, size: size === 'sm' ? 'small' : size === 'lg' ? 'medium' : 'medium', label: label, placeholder: placeholder, required: required, disabled: disabled, error: error, helperText: error ? errorMessage : helperText, InputProps: {
